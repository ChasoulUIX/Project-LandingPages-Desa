            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center mb-8">
                    ...
                    <div class="text-center">
                        <h1 class="text-2xl sm:text-3xl font-bold text-white mb-2">Data Kependudukan</h1>
                        <p class="text-sm text-blue-100">Statistik dan informasi kependudukan desa</p>
                    </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <div class="bg-white/90 backdrop-blur rounded-lg p-4">
                        ...
                        <h3 class="text-2xl font-bold text-blue-900">2,500</h3>
                        <p class="text-xs text-green-600">↑ 2.1% dari bulan lalu</p>
                    </div>
                    <div class="bg-white/90 backdrop-blur rounded-lg p-4">
                        <p class="text-sm text-gray-600">Kepala Keluarga</p>
                        <h3 class="text-2xl font-bold text-blue-900">650</h3>
                        <p class="text-xs text-green-600">↑ 1.5% dari bulan lalu</p>
                    </div>
                    <div class="bg-white/90 backdrop-blur rounded-lg p-4">
                        <p class="text-sm text-gray-600">Penduduk Produktif</p>
                        <h3 class="text-2xl font-bold text-blue-900">1,600</h3>
                        <p class="text-xs text-blue-600">64% dari total penduduk</p>
                    </div>
                    <div class="bg-white/90 backdrop-blur rounded-lg p-4">
                        <p class="text-sm text-gray-600">Rasio Gender</p>
                        <h3 class="text-2xl font-bold text-blue-900">1.02</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white/95 backdrop-blur rounded-xl shadow-sm p-4">
                        <h3 class="text-lg font-semibold text-blue-900 mb-4">Komposisi Gender</h3>
                        <div class="h-48">
                    ...
                    <div class="bg-white/95 backdrop-blur rounded-xl shadow-sm p-4">
                        <h3 class="text-lg font-semibold text-blue-900 mb-4">Distribusi Usia</h3>
                        <div class="h-48">
                    ...
                    <div class="bg-white/95 backdrop-blur rounded-xl shadow-sm p-4">
                        <h3 class="text-lg font-semibold text-blue-900 mb-4">Tingkat Pendidikan</h3>
                        <div class="h-48">
                    ...
                    <div class="bg-white/95 backdrop-blur rounded-xl shadow-sm p-4">
                        <h3 class="text-lg font-semibold text-blue-900 mb-4">Mata Pencaharian</h3>
                        <div class="h-48">
