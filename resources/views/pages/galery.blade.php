        ...
        <div class="bg-gradient-to-b from-blue-900 to-blue-800 py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <h1 class="text-3xl sm:text-4xl font-bold text-white mb-4">Galeri Desa</h1>
                    <p class="text-blue-100">Dokumentasi kegiatan dan momen penting di desa kami</p>
                </div>

                <!-- Filter Categories -->
                <div class="flex flex-wrap justify-center gap-4 mb-8">
                    <button class="bg-yellow-500 text-blue-900 px-4 py-2 rounded-full hover:bg-yellow-400 transition duration-300">
                        Semua
                    </button>
                    <button class="bg-white text-blue-900 px-4 py-2 rounded-full hover:bg-gray-100 transition duration-300">
                        Kegiatan
                    </button>
                    <button class="bg-white text-blue-900 px-4 py-2 rounded-full hover:bg-gray-100 transition duration-300">
                        Pembangunan
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="group relative overflow-hidden rounded-xl">
                        <img src="https://source.unsplash.com/600x400/?village,ceremony" alt="Galeri 1" 
                    ...
                    <!-- Gallery Item 2 -->
                    <div class="group relative overflow-hidden rounded-xl">
                        <img src="https://source.unsplash.com/600x400/?village,development" alt="Galeri 2" 
                             class="w-full h-64 object-cover transform group-hover:scale-110 transition duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition duration-300">
                            <div class="absolute bottom-0 p-6">
                    ...
                    <!-- Gallery Item 3 -->
                    <div class="group relative overflow-hidden rounded-xl">
                        <img src="https://source.unsplash.com/600x400/?village,festival" alt="Galeri 3" 
                             class="w-full h-64 object-cover transform group-hover:scale-110 transition duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition duration-300">
                            <div class="absolute bottom-0 p-6">
                    ...
                    <!-- Gallery Item 4 -->
                    <div class="group relative overflow-hidden rounded-xl">
                        <img src="https://source.unsplash.com/600x400/?village,meeting" alt="Galeri 4" 
                             class="w-full h-64 object-cover transform group-hover:scale-110 transition duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition duration-300">
                            <div class="absolute bottom-0 p-6">
                    ...
                    <!-- Gallery Item 5 -->
                    <div class="group relative overflow-hidden rounded-xl">
                        <img src="https://source.unsplash.com/600x400/?village,harvest" alt="Galeri 5" 
                             class="w-full h-64 object-cover transform group-hover:scale-110 transition duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition duration-300">
                            <div class="absolute bottom-0 p-6">
                    ...
                    <!-- Gallery Item 6 -->
                    <div class="group relative overflow-hidden rounded-xl">
                        <img src="https://source.unsplash.com/600x400/?village,youth" alt="Galeri 6" 
                             class="w-full h-64 object-cover transform group-hover:scale-110 transition duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition duration-300">
                            <div class="absolute bottom-0 p-6">
                ...
                <div class="text-center mt-12">
                    <button class="bg-yellow-500 text-blue-900 px-6 py-3 rounded-lg hover:bg-yellow-400 transition duration-300 font-medium">
                        Muat Lebih Banyak
                    </button>
                </div>
            </div>
